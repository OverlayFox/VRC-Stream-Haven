...
// The Flagship is the local src that initialised the Haven.
...
// MakeEscort creates a types.Escort with the public IP Address of the src that initialised the MakeEscort function.
